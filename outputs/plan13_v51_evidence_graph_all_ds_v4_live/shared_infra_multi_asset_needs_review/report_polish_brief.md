...
- 优先引用事实 ID（按顺序）：fact-scope-obj-01；fact-scope-obj-04；fact-scope-obj-05；fact-scope-obj-02；fact-gap-expand_cluster_scope
### 3. 对象覆盖策略与关键实体
...
- 优先引用事实 ID（按顺序）：fact-gap-expand_cluster_scope；fact-gap-execution_gap；fact-gap-related_assets_review；fact-gap-ground_external_context；fact-gap-check_counterevidence；fact-gap-structure_evidence；fact-gap-validate_family_hint；fact-event-evt-706；fact-event-evt-707
### 10. 结论与后续建议
