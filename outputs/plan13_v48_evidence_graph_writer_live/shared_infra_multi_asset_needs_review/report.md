...
- **本轮不覆盖的范围**：本轮不把未经过独立验证的候选对象 ws-legal-09、ws-legal-12、203.0.113.131、cdn-auth-queue.net、legal-docs-cdn.example、login-queue-cdn.net、socket.io、vercel.app、www.darktrace.com、www.microsoft.com、www.opswat.com、www.reddit.com、www.safeaeon.com 直接写成已确认范围，也不把背景情报直接写成已确认事实。
...
- **扩展查询候选**：ws-legal-09、ws-legal-12、203.0.113.131、cdn-auth-queue.net、legal-docs-cdn.example、login-queue-cdn.net、socket.io、vercel.app、www.darktrace.com、www.microsoft.com、www.opswat.com、www.reddit.com、www.safeaeon.com
- **种子资产**：ws-legal-03
...
- **对象覆盖边界**：当前调查重点仍围绕 `ws-legal-03` 收敛，但还没有资产可以写成已确认受影响范围；候选对象 ws-legal-09、ws-legal-12、203.0.113.131、cdn-auth-queue.net、legal-docs-cdn.example、login-queue-cdn.net、socket.io、vercel.app、www.darktrace.com、www.microsoft.com、www.opswat.com、www.reddit.com、www.safeaeon.com 继续作为边界线索保留。
...
## 7. 传播与关联分析
- **关联扩查主轴**：auth-queue-sync.net、cdn-auth-queue.net、identity-cache.vendor.example、legal-docs-cdn.example、login.microsoftonline.com、login-queue-cdn.net、www.microsoft.com、www.opswat.com、www.reddit.com、www.safeaeon.com、www.darktrace.com、socket.io、vercel.app、198.51.100.131、20.190.160.22、203.0.113.131、t13d190900_7711aa22bb33_9911ccddee77
...
- **未完成独立验证的对象**：ws-legal-09、ws-legal-12、203.0.113.131、cdn-auth-queue.net、legal-docs-cdn.example、login-queue-cdn.net、socket.io、vercel.app、www.darktrace.com、www.microsoft.com、www.opswat.com、www.reddit.com、www.safeaeon.com
