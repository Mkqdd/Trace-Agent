...
- **观测引用**：`obs-001, obs-003, obs-004, obs-006, obs-008`
...
| `obs-008` | `search_related_events` | 扩线检索到 3 条可疑关联事件，围绕 auth-queue-sync.net、198.51.100.131 展开；当前先作为待验证候选线索。 | `candidate` |
