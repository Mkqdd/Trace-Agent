...
- 优先引用事实 ID（按顺序）：fact-scope-obj-01；fact-scope-obj-03；fact-scope-obj-04；fact-scope-obj-02；fact-counter-cl-02
### 3. 对象覆盖策略与关键实体
...
- 优先引用事实 ID（按顺序）：fact-event-evt-602；fact-event-evt-604；fact-counter-cl-02
### 6. 时序特征与行为模式
...
- 优先引用事实 ID（按顺序）：fact-counter-cl-02；fact-counter-cl-06；fact-event-evt-611
### 10. 结论与后续建议
...
- 可引用 packets：scope_packet；constraint_packet
- 优先引用事实 ID（按顺序）：fact-counter-cl-02
