...
- `fact-scope-obj-09` [待确认对象]：对象 `t13d190900_44ac2200b3c1_ab11cd22ee44` 当前作为候选扩展对象保留为待确认范围。；书写边界：仍需独立验证，不能直接升格
### 已确认关联基础设施
- `fact-scope-obj-03` [已确认关联基础设施]：对象 `198.51.100.144` 当前作为已确认关联基础设施纳入主证据链。；书写边界：只应写入外联判断或边界封禁动作，不写成已确认受影响范围
- `fact-scope-obj-04` [已确认关联基础设施]：对象 `files-sync-share.net` 当前作为已确认关联基础设施纳入主证据链。；书写边界：只应写入外联判断或边界封禁动作，不写成已确认受影响范围
### 缺口事实
