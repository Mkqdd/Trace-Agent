...
- **横向对比对象**：198.51.100.131、identity-cache.vendor.example、10.44.1.18、10.44.1.29
...
## 7. 传播与关联分析
- **关联扩查主轴**：auth-queue-sync.net、cdn-auth-queue.net、identity-cache.vendor.example、198.51.100.131、t13d190900_7711aa22bb33_9911ccddee77
- **已确认关联**：在 2026-06-20 10:42:00 UTC，资产 `ws-legal-09` 先解析了少见域名 `cdn-auth-queue.net`。、在 2026-06-20 10:39:00 UTC，资产 `ws-legal-09` 出现了一条与 198.51.100.131 / cdn-auth-queue.net 相关的关键观测。、当前调查一共纳入了 9 条关键事件，当前调查重点仍围绕 `ws-legal-03`。
