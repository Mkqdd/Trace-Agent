...
### Malware Tofsee - SSLBL - Abuse.ch
来源：sslbl.abuse.ch
说明：该来源页面《Malware Tofsee - SSLBL - Abuse.ch》提到了与 `Tofsee` 或指标 `4d7a28d6f2263ed61de88ca66eb011e3` 相关的信息：Timestamp (UTC), Malware Sample (MD5 hash), VT, Signature, Botnet C&C (IP:port). 2021-12-11 18:55...
证据等级：中
参考：[https://sslbl.abuse.ch/ssl-certificates/signature/Tofsee/](https://sslbl.abuse.ch/ssl-certificates/signature/Tofsee/)
...
### Backdoor.Tofsee
来源：malwarebytes.com
说明：Malwarebytes 的检测页面将相关样本归入 `Tofsee` 并给出简要说明。
证据等级：中
...
## 相关情报参考
- [Malware Tofsee - SSLBL - Abuse.ch](https://sslbl.abuse.ch/ssl-certificates/signature/Tofsee/)：该来源页面《Malware Tofsee - SSLBL - Abuse.ch》提到了与 `Tofsee` 或指标 `4d7a28d6f2263ed61de88ca66eb011e3` 相关的信息：Timestamp (UTC), Malware Sample (MD5 hash), VT, Signature, Botnet C&C (IP:port). 2021-12-11 18:55...
...
- [Malware Tofsee - SSLBL - Abuse.ch](https://sslbl.abuse.ch/ssl-certificates/signature/Tofsee/)
  摘要：该来源页面《Malware Tofsee - SSLBL - Abuse.ch》提到了与 `Tofsee` 或指标 `4d7a28d6f2263ed61de88ca66eb011e3` 相关的信息：Timestamp (UTC), Malware Sample (MD5 hash), VT, Signature, Botnet C&C (IP:port). 2021-12-11 18:55...
...
- [Backdoor.Tofsee](https://www.malwarebytes.com/blog/detections/backdoor-tofsee)
  摘要：Malwarebytes 的检测页面将相关样本归入 `Tofsee` 并给出简要说明。
