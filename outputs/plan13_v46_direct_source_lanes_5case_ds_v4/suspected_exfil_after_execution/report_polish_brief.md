...
- `fact-scope-obj-16` [待确认对象]：对象 `blog.talosintelligence.com` 当前作为候选扩展对象保留为待确认范围。；书写边界：仍需独立验证，不能直接升格
- `fact-scope-obj-17` [待确认对象]：对象 `cert.ssi.gouv.fr` 当前作为候选扩展对象保留为待确认范围。；书写边界：仍需独立验证，不能直接升格
### 已确认关联基础设施
