...
def _node_color(node_type: str) -> str:
    mapping = {
        ...
        "fingerprint_ja4": "orange",
        "fingerprint_ssl_sha1": "orange",
        "fingerprint_cert_sha1": "orange",
        "ip": "lightgreen",
...
def _node_label(node: dict) -> str:
    ...
    title_map = {
        ...
        "fingerprint_ja3": "JA3",
        "fingerprint_ja4": "JA4",
        "fingerprint_ssl_sha1": "SSL SHA1",
        "fingerprint_cert_sha1": "CERT SHA1",
        "ip": "IP",
        "external_ip": "IP",
...
def _node_title(node: dict) -> str:
    ...
    title_map = {
        ...
        "fingerprint_ja4": "JA4 Fingerprint",
        "fingerprint_ssl_sha1": "SSL SHA1 Fingerprint",
        "fingerprint_cert_sha1": "CERT SHA1 Fingerprint",
        "ip": "External IP",
